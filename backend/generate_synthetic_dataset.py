...
def generate_leaf_blast(draw):
    ...
    for _ in range(num_spots):
        ...
        draw.ellipse([cx - w, cy - h, cx + w, cy + h], fill=(139, 69, 19))
        draw.ellipse([cx - w + 4, cy - h + 2, cx + w - 4, cy + h - 2], fill=(211, 211, 211))
...
def generate_brown_plant_hopper(draw):
    ...
    for _ in range(num_bugs):
        ...
        color = random.choice([(101, 67, 33), (139, 90, 43), (205, 133, 63)])
