...
async def yield_predict(request: YieldRequest):
    ...
    if model:
        ...
        raw_per_unit = bench["avg"] * rainfall_factor * temp_factor * ph_factor * min(nutrient_score, 1.3)
    ...
    recs = []
    nutrient_score = (request.nitrogen_kg_ha + request.phosphorus_kg_ha + request.potassium_kg_ha) / (90 + 45 + 45)
